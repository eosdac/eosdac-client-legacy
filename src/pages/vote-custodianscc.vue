...
<div class="row gutter-md reverse-wrap">
  ...
  <div class="col-xs-12 col-xl-8" >
    ...
    <div >
      ...
      <div  class="row bg-bg1 q-pa-md q-mb-md shadow-5 round-borders justify-between"  >
...
export default {
  ...
  methods: {
    async init(){
      ...
      if(this.getDacVotes){
        this.selectCandidates(this.getDacVotes)
      }
    },

    selectCandidates(names){
      this.getSelectedCand.forEach(sc=>{
        sc.selected = false;
      })
      names.forEach(n =>{
        let cand = this.custodians.find(c => c.candidate_name == n);
        if(cand){
          cand.selected = true;
        }
      })
