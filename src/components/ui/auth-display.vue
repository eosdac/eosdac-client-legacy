...
<div class="row justify-start items-center">
  ...
  <div v-for ="(a,i) in getAllAuth" :key="`auth${i}`"  class="round-borders q-body-1 q-pa-sm q-ma-xs bg-bg1 row items-center">
  ...
  <div class="row">
    ...
    <q-input dark hide-underline color="primary-light" placeholder="actor@permission" style="margin-left:5px" v-model="new_auth" @keyup.enter.native="addAuth(new_auth)"/>
  </div>
</div>
</template>
