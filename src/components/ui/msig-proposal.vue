  ...
  <div>
    ...
    >
        ...
        <div class="full-width q-mt-xs">
          <span class="text-text1">
            ...
            <span class="text-text2">
              {{ new Date(msig.block_time).toDateString() }}
            </span>
          </span>
        </div>
      </div>
      ...
      <div class="row q-pa-md justify-between relative-position items-center">
        <div
          v-if="msig.status == 1 || msig.status == 2"
        ...
        <div class="text-text1 bg-bg2 full-height">
          ...
          <div class="q-pa-md">
            <q-item>
              ...
              <q-item-main>{{ msig.title }}</q-item-main>
            </q-item>
            ...
            <div class="q-pt-md q-body-1" style="border-top:1px solid grey">
              ...
              <div class="q-pb-xs">
                ...
                <span class="text-text2">
                  {{ new Date(msig.block_time).toUTCString() }}
                </span>
              </div>
              <div class="q-pb-xs">
  ...
  methods: {
    ...
    async checkApprovals() {
      ...
      if (this.msig.status === 1) {
        approvals = await this.$store.dispatch(
          'dac/fetchApprovalsFromProposal',
          {
            proposer: this.msig.proposer,
            proposal_name: this.msig.proposal_name
          }
        );
      ...
      let avatars = await this.$profiles.getAvatars([
        ...approvals.provided_approvals.map(a => a.actor),
        ...approvals.requested_approvals.map(a => a.actor)
      ]);
