<template>
<div v-if="getSettingByName('debug_data_structure').value" class="debug_data_structure bg-bg1 q-pa-md q-mt-md round-borders shadow-5 animate-fade" >
  ...
  <div id="debug_data_output" class="overflow-hidden" v-html="debug_data_structures"></div>
