    ...
    <div class="fixed-center">
      ...
      <div class="text-center " style="height:80px">
        ...
        <div v-if="getShowTransactionOverlay=='loading'">
          <q-icon style="height:80px" name="vertical_align_bottom" color="primary-light" class="animate-bounce animate-fade" size="50px" />
          <div class=" text-white animate-fade" style="height:50px">loading</div>
        </div>
        ...
        <div v-if="getShowTransactionOverlay=='success'">
          <q-icon  style="height:80px" name="check_circle_outline" color="positive" class="animate-scale" size="70px" />
          <div class=" text-white animate-fade" style="height:50px">Transaction success</div>
        ...
        <div v-if="getShowTransactionOverlay=='cancelled'">
          <q-icon style="height:80px" name="error_outline" color="negative" class="animate-scale" size="70px" />
          <div class=" text-white animate-fade" style="height:50px">Transaction cancelled</div>
        </div>
