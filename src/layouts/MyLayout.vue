        ...
        <q-toolbar-title>
          <span v-if="getIsDark">
            <img
              ...
              @click="$router.push('/')"
              src="~assets/images/logo-main-light.svg"
              style="height:48px;"
            ...
            <img
              ...
              @click="$router.push('/')"
              src="~assets/images/logo-notext-light.svg"
              style="height:48px;"
              :title="$t('default.member_client')"
            />
          </span>
          <span v-if="!getIsDark">
            <img
              class="cursor-pointer gt-xs"
              @click="$router.push('/')"
              src="~assets/images/logo-main-dark.svg"
              style="height:48px;"
              :title="$t('default.member_client')"
            />
            <img
              class="cursor-pointer lt-sm"
              @click="$router.push('/')"
              src="~assets/images/logo-notext-dark.svg"
              style="height:48px;"
              :title="$t('default.member_client')"
            />
          </span>
